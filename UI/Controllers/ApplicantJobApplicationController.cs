...
namespace UI.Controllers
{
    public class ApplicantJobApplicationController : Controller
    {
        ...
        private readonly CompanyJobDescriptionLogic _clogic;

        public ApplicantJobApplicationController(CareerCloudContext context)
        {
            _context = context;
            var repos = new EFGenericRepository<CompanyJobDescriptionPoco>();
            _clogic = new CompanyJobDescriptionLogic(repos);
        }
